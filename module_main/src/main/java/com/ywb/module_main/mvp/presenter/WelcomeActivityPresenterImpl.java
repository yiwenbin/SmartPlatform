...
import com.ywb.module_main.WelcomeService;
...
import com.zbiti.smart_platform_base.utils.LocaCacheUtils;
...
public class WelcomeActivityPresenterImpl extends WelcomeActivityPresenter {
  ...
  private final String testPicUrl = "image/pic/item/e1fe9925bc315c609e11bbb781b1cb13485477e6.jpg";//todo 测试广告图
  ...
  private void getAdvertisementFromNet() {
    WelcomeService welcomeService = RetrofitServiceCreate
        .createdService(WelcomeService.class,AppUtils.getContext(),testBaseUrl);
